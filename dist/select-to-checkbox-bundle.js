(function ($) {
    ...
    function () {
      function SelectToCheckbox(selectTarget, args) {
        ...
        this.options.forEach(function (o) {
          return _this.div.append(o.getListItem());
        });
      ...
      SelectToCheckbox.prototype.disableNoPermissionCheck = function () {
        this.previouslyEnabledOptions = this.options.filter(function (o) {
          return !o.isDisabled();
        });
        this.options.forEach(function (o) {
          return o.disable();
      ...
      SelectToCheckbox.prototype.enable = function () {
        ...
        this.previouslyEnabledOptions.forEach(function (o) {
          return o.enable();
        });
      };
    ...
    $__default['default'].fn.selectToCheckbox = function (args) {
      var target = this; // merge the global options with the per-call options.

      args = $__default['default'].extend({}, $__default['default'].fn.selectToCheckbox.args, args); // factory defaults
      ...
      var stc = $__default['default'](selectToCheckbox.getRootElement());
...
//# sourceMappingURL=select-to-checkbox-bundle.js.map
